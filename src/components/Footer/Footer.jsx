...
const Footer = () => {
  return (
    ...
    <div className="container p-6 mx-auto">
        <div className="lg:flex">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    <div>
                        <h3 className="font-bold uppercase dark:text-white">Inicio</h3>
                    ...
                    <div>
                        <h3 className="font-bold uppercase dark:text-white">Marcas</h3>
                    ...
                    <div>
                        <h3 className="font-bold uppercase dark:text-white">¿Quienes Somos?</h3>
                    ...
                    <div>
                        <h3 className="font-bold uppercase dark:text-white">Repuestos y Herramientas</h3>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© Crenagro  2024 - All rights reserved</p>
        </div>
    </div>
</footer>
  )
