...
import video2 from '../SeccionesRyH/video2';

const Hero = () => {
  return (
    <div className='  relative mx-4  md:mx-10 md:h-40vh text-white bg-cover bg-center h-[calc(96vh-8rem)] '>
      <video2/>
      <div className='mx-4 my-28  flex flex-col items-center justify-center rounded-3xl bg-cover bg-center text-white h-full relative gap-9'>
