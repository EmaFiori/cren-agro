    ...
    return (
      <div className="relative isolate overflow-hidden bg-white px-6 my-10 sm:my-[-10rem] sm:mx-[6rem] sm:ml-[8rem] lg:overflow-visible lg:px-0 lg:my-28">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          <div className="animate__fadeInLeft lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
