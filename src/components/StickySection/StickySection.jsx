              ...
              <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                ...
                <ul role="list" className="mt-8 space-y-8 text-gray-600">
                  <li className="flex gap-x-3">
                    <CloudArrowUpIcon className="mt-1 h-5 w-5 flex-none text-rojo" aria-hidden="true" />
                    <span>
                  ...
                  <li className="flex gap-x-3">
                    <LockClosedIcon className="mt-1 h-5 w-5 flex-none text-rojo" aria-hidden="true" />
                    <span>
                  ...
                  <li className="flex gap-x-3">
                    <ServerIcon className="mt-1 h-5 w-5 flex-none text-rojo" aria-hidden="true" />
                    <span>
